...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            ## Predicting Students Seeking Help for Anxiety or Depression

            Graduate students seem exceptionally prone to mental health issues.

            Graduate education programs have only recently started to take students' mental health as seriously as their physical health.

            Just like physical health, identifying at-risk individuals is key to prevention.

            Can we predict whether a student will reach out for help for anxiety and depression in the future?

            """
        ),
        dcc.Link(dbc.Button('Try the predictor', color='primary'), href='/predictions')
    ],
    md=5,
)
